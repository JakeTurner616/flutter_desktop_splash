...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Builder(
        builder: (context) =>
            // Conditionally show splash screen only on desktop platforms
            Platform.isWindows || Platform.isMacOS || Platform.isLinux
                ? DesktopSplashScreen(
                    ...
                    backgroundColor: Colors
                        .blueAccent, // Background color for the splash screen
                    duration: Duration(
                        seconds: 6), // Duration to display the splash screen
                    ...
                    loadingIndicator: LoadingIndicator(
                      indicatorType: Indicator
                          .ballClipRotatePulse, // Choose animation type
                ...
                : HomePage(), // Directly show HomePage on non-desktop platforms
      ),
    );
  }
}
